 ...
 */
const getMyAssignedCourseById = async (courseAssignmentId, employeeId) => {
    const assignment = await courseAssignmentModel_1.default.findOne({ _id: courseAssignmentId, employeeId })
