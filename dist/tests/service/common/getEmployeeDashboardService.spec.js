...
const packageFindMock = employeePackageModel_1.default.find;
...
describe('getEmployeeDashboardService', () => {
    ...
    const mockPackageChain = (documents) => {
    ...
    it('returns the full dashboard aggregation for the employee', async () => {
        ...
        const result = await getEmployeeDashboardService_1.default.getEmployeeDashboard('u1');
