...
jest.mock('../../../model/poolCompanies', () => {
    ...
    PoolCompaniesModel.deleteOne = jest.fn();
    PoolCompaniesModel.updateOne = jest.fn();
...
describe('deletePoolCompanyByAdminService', () => {
    ...
    it('hard deletes a pool company and resolves { success: true }', async () => {
        ...
        const result = await deletePoolCompanyByAdminService_1.default.hardDeletePoolCompanyByAdmin('co1');
    ...
    it('rejects { success: false } and logs when hard delete fails', async () => {
        ...
        await expect(deletePoolCompanyByAdminService_1.default.hardDeletePoolCompanyByAdmin('co1'))
    ...
    it('soft deletes a pool company and resolves { success: true }', async () => {
        ...
        const result = await deletePoolCompanyByAdminService_1.default.softDeletePoolCompanyByAdmin('co1');
    ...
    it('rejects { success: false } and logs when soft delete fails', async () => {
        ...
        await expect(deletePoolCompanyByAdminService_1.default.softDeletePoolCompanyByAdmin('co1'))
            .rejects.toEqual({ success: false });
        expect(console.error).toHaveBeenCalled();
    });
});
