...
jest.mock('../../../model/employeePackageModel', () => {
    ...
    EmployeePackageModel.find = jest.fn();
...
const buildFindLeanChain = (mock, value) => {
    const chain = {
...
describe('getDashboardStatsByAdminService', () => {
    ...
    it('aggregates employee, timesheet, birthday and anniversary statistics', async () => {
        ...
        const result = await getDashboardStatsByAdminService_1.default.getDashboardStatsByAdmin('org1', 'adminId');
        ...
        expect(result.recentHires.map((h) => h.employeeId)).toEqual(['EMP-3', 'EMP-2', 'EMP-1']);
