...
const findByIdMock = talentPoolCandidatesModel_1.default.findById;
...
describe('getTalentPoolCandidateByIdService', () => {
    ...
    it('resolves with candidate details when comments are converted to timestamps and sorted', async () => {
        ...
        const result = await getTalentPoolCandidateByIdService_1.default.getTalentPoolCandidateDetails('t1');
    ...
    it('rejects with { success: false } when the candidate does not exist', async () => {
        ...
        await expect(getTalentPoolCandidateByIdService_1.default.getTalentPoolCandidateDetails('t1')).rejects.toEqual({
            success: false
        });
    });
