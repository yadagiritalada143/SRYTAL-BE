...
const employeePackageDetailsByIdMock = employeePackageDetailsByIdService_1.default.employeePackageDetailsById;
...
describe('employeePackageDetailsByIdController', () => {
    ...
    it('returns 400 when dates are missing', async () => {
        ...
        await employeePackageDetailsByIdController_1.default.employeePackageDetailsById(req, res);
