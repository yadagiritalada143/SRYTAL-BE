...
const sendResetPasswordMail = async (firstName, lastName, userName, tempPassword) => {
    try {
    ...
    <div style="max-width: 750px; height:auto; margin: 0 auto; border: 1px solid #f7f1f4; border-radius: 5px;">
      ...
      <div style="background-color: rgb(220, 235, 248); padding: 20px; color: #4f4a4c;">
        ...
        <p style="margin: 0 0 15px; font-size: 14px; color: #333;">
          Your account password has been reset by the administrator for security reasons.
        </p>

        <p style="margin: 0 0 15px; font-size: 14px; color: #333;">
          Please use the temporary password below to log in to the system. After logging in,
          you must change your password immediately.
        </p>

        <p style="margin: 0 0 15px; font-size: 14px; color: #333;">
          <b>Your Temporary Password:</b> ${tempPassword}
        </p>

        <p style="margin: 0 0 15px; font-size: 14px; color: #d9534f; font-weight: bold;">
          <u>Important:</u> Please change your password as soon as possible to keep your account secure.
        </p>

        <p style="margin: 0 0 15px; font-size: 14px; color: #333;">
          If you face any issues or did not request this change, please contact us at
