...
const sendCustomerThankYouEmail = async (details) => {
    try {
  ...
  <body style="font-family: serif; background-color: #f4f4f9; padding: 20px;">
    <div style="max-width: 750px; height: auto; margin: 0 auto; border: 1px solid #f7f1f4; border-radius: 5px;">
      ...
      <div style="background-color: rgb(220, 235, 248); padding: 20px; color: #4f4a4c;">
        ...
        console.error('Customer Thank You Email sending FAILED!', (error === null || error === void 0 ? void 0 : error.message) || error);
    }
};
const sendAdminNotificationEmail = async (details) => {
    try {
        const transporter = nodemailer_1.default.createTransport(emailConfiguration);
        const mailBody = `
<html>
  <body style="font-family: serif; background-color: #f4f4f9; padding: 20px;">
    <div style="max-width: 750px; height: auto; margin: 0 auto; border: 1px solid #f7f1f4; border-radius: 5px;">
      ...
      <div style="background-color: rgb(220, 235, 248); padding: 20px; color: #4f4a4c;">
        ...
        console.error('Admin Notification Email sending FAILED!', (error === null || error === void 0 ? void 0 : error.message) || error);
    }
};
exports.default = { sendCustomerThankYouEmail, sendAdminNotificationEmail };
