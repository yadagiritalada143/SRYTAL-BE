...
const getAllFeedbackAttributesByAdmin = async (req, res) => {
    try {
        const feedbackAttributes = await getAllFeedbackAttributeByAdminService_1.default.getAllFeedbackAttributeByAdmin();
...
exports.default = { getAllFeedbackAttributesByAdmin };
