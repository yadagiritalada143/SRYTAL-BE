...
const addFeedbackAttributeByAdmin = async (req, res) => {
    try {
        const { name } = req.body;
        await addFeedbackAttributeByAdminService_1.default.addFeedbackAttributeByAdmin(name);
...
exports.default = { addFeedbackAttributeByAdmin };
