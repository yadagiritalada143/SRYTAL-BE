...
exports.HTTP_STATUS = exports.PROGRAMMING_LANGUAGES_ERROR_MESSAGES = exports.PROGRAMMING_LANGUAGES_SUCCESS_MESSAGES = void 0;
exports.PROGRAMMING_LANGUAGES_SUCCESS_MESSAGES = {
    ...
    PROGRAMMING_LANGUAGE_DELETE_SUCCESS_MESSAGE: 'Programming language deleted successfully !',
};
exports.PROGRAMMING_LANGUAGES_ERROR_MESSAGES = {
    ...
    PROGRAMMING_LANGUAGE_DELETE_ERROR_MESSAGE: 'An error occurred while deleting programming language !',
    PROGRAMMING_LANGUAGE_DELETE_NOT_FOUND_MESSAGE: 'Programming language not found !'
};
exports.HTTP_STATUS = {
    OK: 200,
    CREATED: 201,
