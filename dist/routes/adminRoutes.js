...
const deleteCourseAssignmentController_1 = __importDefault(require("../controllers/admin/deleteCourseAssignmentController"));
...
const authorizeAdmin_1 = __importDefault(require("../middlewares/authorizeAdmin"));
 ...
 */
adminRouter.get('/getDashboardStatsByAdmin', validateJWT_1.default, getDashboardStatsByAdminController_1.default.getDashboardStats);
 ...
 */
adminRouter.get('/getNavCatalog', validateJWT_1.default, getNavCatalogController_1.default.getNavCatalog);
/**
 * @swagger
 ...
 */
adminRouter.get('/getNavRoleAccess/:role', validateJWT_1.default, getNavRoleAccessController_1.default.getNavRoleAccess);
/**
 * @swagger
 ...
 */
adminRouter.put('/updateNavRoleAccess', validateJWT_1.default, updateNavRoleAccessController_1.default.updateNavRoleAccess);
/**
 * @swagger
 ...
 */
adminRouter.get('/getNavUserAccess/:userId', validateJWT_1.default, getNavUserAccessController_1.default.getNavUserAccess);
/**
 * @swagger
 ...
 */
adminRouter.put('/updateNavUserAccess', validateJWT_1.default, updateNavUserAccessController_1.default.updateNavUserAccess);
/**
 * @swagger
 ...
 */
adminRouter.post('/addPackageByAdmin', validateJWT_1.default, addPackageByAdminController_1.default.addPackageByAdmin);
/**
 * @swagger
 ...
 */
adminRouter.put('/updatePackageByAdmin', validateJWT_1.default, updatePackageByAdminController_1.default.updatePackageByAdmin);
/**
 * @swagger
 ...
 */
adminRouter.post('/addTaskByAdmin', validateJWT_1.default, addTaskByAdminController_1.default.addTaskByAdmin);
/**
 * @swagger
 ...
 */
adminRouter.put('/updateTaskByAdmin', validateJWT_1.default, updateTaskByAdminController_1.default.updateTaskByAdmin);
/**
 * @swagger
 ...
 */
adminRouter.post('/addfeedbackattributebyadmin', addFeedbackAttributeByAdminController_1.default.addFeedbackAttributeByAdmin);
/**
 * @swagger
 ...
 *         description: Internal Server Error
 */
adminRouter.put('/updatefeedbackattributebyadmin', validateJWT_1.default, updateFeedbackAttributeByAdminController_1.default.updateFeedbackAttributeByAdmin);
/**
 * @swagger
 ...
 */
adminRouter.get('/getfeedbackattributebyadmin/:id', validateJWT_1.default, getFeedbackAttributeByAdminController_1.default.getFeedbackAttributeByAdmin);
/**
 * @swagger
 ...
 */
adminRouter.get('/getallfeedbackattributesbyadmin', validateJWT_1.default, getAllFeedbackAttributeByAdminController_1.default.getAllFeedbackAttributesByAdmin);
/**
 * @swagger
 ...
 */
adminRouter.delete('/deletefeedbackattributebyadmin/:id', validateJWT_1.default, deleteFeedbackAttributeByAdminController_1.default.deleteFeedbackAttributeByAdmin);
/**
 * @swagger
 ...
 */
adminRouter.post('/adddepartmentbyadmin', validateJWT_1.default, addDepartmentByAdminController_1.default.addDepartmentByAdmin);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
adminRouter.get('/getalldepartmentsbyadmin', validateJWT_1.default, getAllDepartmentsByAdminController_1.default.getAllDepartmentsByAdmin);
/**
 * @swagger
 ...
 */
adminRouter.delete('/deletedepartmentbyadmin/:_id', validateJWT_1.default, deleteDepartmentByAdminController_1.default.deleteDepartmentByAdmin);
/**
 * @swagger
 ...
 */
adminRouter.put('/updatedepartmentbyadmin', validateJWT_1.default, updateDepartmentByAdminController_1.default.updateDepartmentByAdmin);
/**
 * @swagger
 ...
 */
adminRouter.post('/createcourseassignment', validateJWT_1.default, createCourseAssignmentController_1.default.createCourseAssignment);
/**
 * @swagger
 ...
 */
adminRouter.get('/getallcourseassignments', validateJWT_1.default, authorizeAdmin_1.default, getAllCourseAssignmentsController_1.default.getAllCourseAssignments);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
adminRouter.get('/courses/assignments/:courseAssignmentId/details', validateJWT_1.default, authorizeAdmin_1.default, getCourseAssignmentDetailsController_1.default.getCourseAssignmentDetails);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
adminRouter.put('/courses/assignments/:courseAssignmentId/duedate', validateJWT_1.default, authorizeAdmin_1.default, updateCourseAssignmentDueDateController_1.default.updateCourseAssignmentDueDate);
/**
 * @swagger
 ...
 *                   example: Internal server error
 */
adminRouter.delete('/deletecourseassignment/:courseAssignmentId', validateJWT_1.default, deleteCourseAssignmentController_1.default.deleteCourseAssignment);
/**
 * @swagger
 ...
 */
adminRouter.get('/courses/assigned/:userId', validateJWT_1.default, authorizeAdmin_1.default, fetchAssignedCoursesForEmployeeController_1.default.fetchAssignedCoursesForEmployee);
