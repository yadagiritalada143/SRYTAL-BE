...
adminRouter.post(
  ...
  validateJWT,
  validateRegistrationSchema(registrationSchema),
  registerEmployeeByAdminController.register
);
 ...
 */
adminRouter.get(
  '/getEmployeeDetailsByAdmin/:id',
  validateJWT,
  getEmployeeDetailsByAdminController.getUserDetails
);
...
adminRouter.put(
  ...
  validateProfileRequest(userSchema),
  validateJWT,
  updateEmployeeDetailsByAdminController.updateProfile
);
...
adminRouter.get(
  ...
  validateJWT,
  getAllEmployeeDetailsByAdminController.getAllEmployeeDetails
);
 ...
 */
adminRouter.post(
  '/employeePasswordResetByAdmin',
  employeePasswordResetByAdminController.employeePasswordResetByAdmin
);
...
adminRouter.get(
  ...
  validateJWT,
  getAllBloodGroupsByAdminController.getAllBloodGroupsDetails
);
...
adminRouter.post(
  ...
  validateJWT,
  addBloodGroupByAdminController.addNewBloodgroupByAdmin
);
adminRouter.post(
  '/deleteEmployeeByAdmin',
  validateJWT,
  deleteEmployeeDetailsByAdminController.deleteProfile
);
...
adminRouter.delete(
  ...
  validateJWT,
  deleteBloodGroupByAdminController.deleteBloodGroup
);
...
adminRouter.put(
  ...
  validateJWT,
  updateBloodGroupByAdminController.updateBloodGroup
);
...
adminRouter.post(
  ...
  validateJWT,
  addEmploymentTypeByAdminController.addEmploymentTypeByAdmin
);
...
adminRouter.get(
  ...
  validateJWT,
  getAllEmploymentTypesByAdminController.getAllEmploymentTypesByAdmin
);
...
adminRouter.put(
  ...
  validateJWT,
  updateEmploymentTypeByAdminController.updateEmploymentType
);
...
adminRouter.delete(
  ...
  validateJWT,
  deleteEmploymentTypeByAdminController.deleteEmploymentType
);
...
adminRouter.post(
  ...
  validateJWT,
  addEmployeeRoleByAdminController.addEmployeeRoleByAdmin
);
...
adminRouter.get(
  ...
  validateJWT,
  getAllEmployeeRoleByAdminController.getAllEmployeeRolesByAdmin
);
...
adminRouter.put(
  ...
  validateJWT,
  updateEmployeeRoleByAdminController.updateEmployeeRole
);
 ...
 */
adminRouter.delete(
  '/deletePoolCandidatesByAdmin/:id',
  validateJWT,
  deletePoolCandidateByadminController.deletePoolCandidateByAdmin
);
 ...
 */
adminRouter.delete(
  '/deletePoolCompanyByAdmin/:id',
  validateJWT,
  deletePoolCompanyByAdminController.deletePoolCompanyByAdmin
);
...
adminRouter.post(
  '/addPackageByAdmin',
  validateJWT,
  addPackageByAdminController.addPackageByAdmin
);
...
adminRouter.get(
  ...
  validateJWT,
  getAllPackagesByAdminController.getAllPackagesDetails
);
 ...
 */
adminRouter.get(
  '/getPackageDetailsByAdmin/:id',
  validateJWT,
  getPackageDetailsByAdminController.getPackageDetailsByAdmin
);
...
adminRouter.delete(
  ...
  validateJWT,
  deletePackageByAdminController.deletePackageByAdmin
);
...
adminRouter.put(
  ...
  validateJWT,
  updatePackageByAdminController.updatePackageByAdmin
);
...
adminRouter.post(
  '/addTaskByAdmin',
  validateJWT,
  addTaskToPackageByAdminController.addTaskByAdmin
);
...
adminRouter.put(
  '/updateTaskByAdmin',
  validateJWT,
  updateTaskByAdminController.updateTaskByAdmin
);
...
adminRouter.delete(
  ...
  validateJWT,
  deleteTaskByAdminController.deleteTaskByAdmin
);
...
adminRouter.post(
  ...
  validateJWT,
  addPackageToEmployeeByAdminController.addPackageToEmployeeByAdmin
);
 ...
 */
adminRouter.get(
  '/getEmployeePackagesByAdmin/:employeeId',
  validateJWT,
  getEmployeePackageByAdminController.getEmployeePackageDetailsByAdmin
);
...
adminRouter.delete(
  ...
  validateJWT,
  deleteEmployeePackagesByAdminController.deleteEmployeePackageByAdmin
);
 ...
 */
adminRouter.delete(
  '/deleteEmployeeTaskByAdmin',
  validateJWT,
  deleteEmployeeTaskByAdminController.deleteEmployeeTaskByAdmin
);
...
adminRouter.post(
  '/generateSalarySlip',
  validateJWT,
  generateSalarySlipByAdminController.generateSalarySlip
);
...
adminRouter.post(
  '/previewSalarySlip',
  validateJWT,
  generateSalarySlipByAdminController.previewSalarySlip
);
...
adminRouter.post(
  ...
  addFeedbackAttributeByAdminController.addFeedbackAttributeByAdmin
);
...
adminRouter.put(
  ...
  validateJWT,
  updateFeedbackAttributeByAdminController.updateFeedbackAttributeByAdmin
);
 ...
 */
adminRouter.get(
  '/getfeedbackattributebyadmin/:id',
  validateJWT,
  getFeedbackAttributeByAdminController.getFeedbackAttributeByAdmin
);
...
adminRouter.get(
  ...
  validateJWT,
  getAllFeedbackAttributeByAdminController.getAllFeedbackAttributesByAdmin
);
 ...
 */
adminRouter.delete(
  '/deletefeedbackattributebyadmin/:id',
  validateJWT,
  deleteFeedbackAttributeByAdminController.deleteFeedbackAttributeByAdmin
);
...
adminRouter.post(
  ...
  validateJWT,
  addDepartmentByAdminController.addDepartmentByAdmin
);
...
adminRouter.get(
  ...
  validateJWT,
  getAllDepartmentsByAdminController.getAllDepartmentsByAdmin
);
 ...
 */
adminRouter.get(
  '/getdepartmentbyadmin/:_id',
  validateJWT,
  getDepartmentByAdminController.getDepartmentByAdmin
);
 ...
 */
adminRouter.delete(
  '/deletedepartmentbyadmin/:_id',
  validateJWT,
  deleteDepartmentByAdminController.deleteDepartmentByAdmin
);
...
adminRouter.put(
  ...
  validateJWT,
  updateDepartmentByAdminController.updateDepartmentByAdmin
);
