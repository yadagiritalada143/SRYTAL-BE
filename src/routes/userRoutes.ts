...
import getUserOpenRouterKeyController from '../controllers/useropenrouter/getUserOpenRouterKeyController';
import validateAndSaveOpenRouterKeyController from '../controllers/useropenrouter/validateAndSaveOpenRouterKeyController';
...
userOpenRouter.get('/getuseropenrouterkey', validateJWT, getUserOpenRouterKeyController.getUserOpenRouterKey);
...
userOpenRouter.post('/validateandsaveopenrouterapikey', validateJWT, validateAndSaveOpenRouterKeyController.validateAndSaveOpenRouterKeyController);
