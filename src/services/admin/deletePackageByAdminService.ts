...
const hardDeletePackageServiceByAdmin = async (
  packageIdToDelete: any
): Promise<IDeletePackageResponse> => {
  return new Promise(async (resolve, reject) => {
    await PackagesModel.deleteOne({ _id: packageIdToDelete })
...
const softDeletePackageServiceByAdmin = async (
  packageIdToDelete: string
): Promise<IDeletePackageResponse> => {
  return new Promise(async (resolve, reject) => {
