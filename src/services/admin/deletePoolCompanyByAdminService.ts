...
const hardDeletePoolCompanyByAdmin = async (
  poolCompanyIdToDelete: any
): Promise<IDeletePoolCompanyResponse> => {
  return new Promise(async (resolve, reject) => {
    await PoolCompaniesModel.deleteOne({ _id: poolCompanyIdToDelete })
...
const softDeletePoolCompanyByAdmin = async (
  poolCompanyIdToDelete: string
): Promise<IDeletePoolCompanyResponse> => {
  return new Promise(async (resolve, reject) => {
