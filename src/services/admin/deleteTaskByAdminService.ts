...
const hardDeleteTaskByAdmin = async (
  taskIdToDelete: any
): Promise<IDeleteTaskResponse> => {
  return new Promise(async (resolve, reject) => {
    await TaskModel.deleteOne({ _id: taskIdToDelete })
...
const softDeleteTaskByAdmin = async (
  taskIdToDelete: string
): Promise<IDeleteTaskResponse> => {
  return new Promise(async (resolve, reject) => {
    await TaskModel.updateOne({ _id: taskIdToDelete }, { isDeleted: true })
