...
export interface ISendLeaveApprovalEmailDetails {
    employeeName: string;
...
const sendLeaveApprovalEmail = async (details: ISendLeaveApprovalEmailDetails): Promise<void> => {
    try {
  ...
  <body style="font-family: serif; background-color: #f4f4f9; padding: 20px;">
    <div style="max-width: 750px; height: auto; margin: 0 auto; border: 1px solid #f7f1f4; border-radius: 5px;">
      ...
      <div style="background-color: rgb(220, 235, 248); padding: 20px; color: #4f4a4c;">
        ...
        <p style="margin: 0 0 15px; font-size: 14px; color: #333;">
          We are pleased to inform you that your leave request has been <b>approved</b>. Please find the details below.
        </p>
        ...
        const mailOptions = {
            ...
            subject: `Leave Request Approved - ${details.leaveType}`,
            html: mailBody,
        };
...
export default { sendLeaveApprovalEmail };
