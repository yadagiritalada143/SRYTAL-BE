...
export interface ICourseCompletionEmailDetails {
    adminEmail: string;
    adminName?: string;
    employeeName: string;
    courseName: string;
...
const sendCourseCompletionEmail = async (details: ICourseCompletionEmailDetails): Promise<void> => {
...
export default { sendCourseCompletionEmail };
