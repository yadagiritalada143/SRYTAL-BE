...
import {
  ...
  IPDFGenerationResult,
} from '../../interfaces/pdfGenerator';
...
const getBrowser = async () => {
  ...
  console.warn(
    '[PDFGenerator] Environment Check - VERCEL:',
    process.env.VERCEL || 'NOT SET'
  );
  console.warn(
    '[PDFGenerator] Environment Check - AWS_LAMBDA_FUNCTION_NAME:',
  ...
  if (isVercel) {
    console.warn(
      '[PDFGenerator] Getting chromium executable path for Vercel...'
    );
...
export const generatePDFFromHTML = async (
  ...
  console.warn(
    '[PDFGenerator] HTML content length:',
  ...
  try {
    ...
    console.warn(
      '[PDFGenerator] Merged PDF Options:',
