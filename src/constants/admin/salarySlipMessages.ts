...
export const SALARY_SLIP_ERROR_MESSAGES = {
  ...
  SALARY_SLIP_MISSING_REQUIRED_FIELDS:
    'Missing required fields for salary slip generation !!',
  SALARY_SLIP_UNEXPECTED_ERROR:
    'An unexpected error occurred while generating salary slip !!',
