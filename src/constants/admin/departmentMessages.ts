export const DEPARTMENT_SUCCESS_MESSAGES = {
  ...
  FETCH_ALL_DEPARTMENTS_SUCCESS_MESSAGE:
    'Fetched all departments successfully !!',
  FETCH_DEPARTMENT_SUCCESS_MESSAGE:
    'Fetched department details successfully !!',
...
export const DEPARTMENT_ERROR_MESSAGES = {
  ...
  FETCH_ALL_DEPARTMENTS_ERROR_MESSAGE:
    'An error occurred while fetching all departments !!',
  FETCH_DEPARTMENT_ERROR_MESSAGE:
  ...
  DEPARTMENT_UPDATE_ERROR_MESSAGE:
