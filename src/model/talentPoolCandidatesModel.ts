...
const TalentPoolCandidatesSchema = new mongoose.Schema(
  {
    ...
    isResumeWithDetailsUpload: { type: mongoose.Schema.Types.Boolean },
    isResumeWithoutDetailsUpload: { type: mongoose.Schema.Types.Boolean },
...
const TalentPoolCandidatesModel = mongoose.model<ITalentPoolCandidates>(
  'TalentPoolCandidatesSchema',
  TalentPoolCandidatesSchema
);
